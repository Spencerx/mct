...
public class TestOpenMultipleMonitorsThisAction {

    private OpenMultipleMonitorsThisAction openMultiMonitorsThissAction;
    ...
    public void testIsEnabled() {
       Assert.assertNotNull(openMultiMonitorsThissAction);
    }
